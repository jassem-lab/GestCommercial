        ...
        <header id="topnav">
            <div class="topbar-main" style="background-color: #2054c966">
                <div class="container-fluid">
                    <div class="logo">
							<b style="text-align: center; color: #102677;font-family: Roboto, sans-serif;font-size: 16.5px;">Gestion commerciale</b> 
                    </div>
...
?>
							...
							<?php if ($_SESSION['delta_PROFIL'] == 1) { ?> 
							 <ul class="navigation-menu">
									...
									<li class="has-submenu">
										<a href="#" style="font-size: 12px;"><i class="mdi mdi-buffer" ></i>Mouvements fournisseurs</a>
										<ul class="submenu megamenu">
											<li>
												<ul>
													<li><a href="gest_be.php"><b style="font-size:12px">Entrée Marchandises </a></b></li>
													<li><a href="gest_bs.php"><b style="font-size:12px">Sorties Marchandises</a></b></li>
												</ul>
											</li>
										...
										<ul class="submenu megamenu">
											<li>
												<ul>
													...
													<li><a href="gest_bc.php"><b style="font-size:12px">Commandes Clients</a></b></li>
													<li><a href="gest_bl.php"><b style="font-size:12px">Livraison Clients</a></b></li>
									...
									<li class="has-submenu">
										...
										<ul class="submenu megamenu">
											<li>
												<ul>
													<li><a href="gest_paie_cli.php"><b style="font-size:12px">Paiement Client</a></b></li>
										...
										<ul class="submenu megamenu">
											<li>
												<ul>
													...
													<li><a href="stock_prd.php"><b style="font-size:11px">Stock produits</a></b></li>
													<li><a href="mvt_stock.php"><b style="font-size:11px">Mouvement de stock</a></b></li>
