                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 col-md-3 mt-5">
                                        <div class="text-center">
                                            <!-- Large modal -->
                                            <button type="button" class="btn btn-danger waves-effect waves-light"
                                                data-toggle="modal" data-target=".bs-example-modal-dates">Plus de
                                                Détails
                                                Dates</button>
                                        </div>
                                        <!--  Modal content for the above example -->
                                        <div class="modal fade bs-example-modal-dates" tabindex="-1" role="dialog"
                                            aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h2 class="modal-title mt-0" id="myLargeModalLabel">Détails
                                                            Dates</h2>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-hidden="true">×</button>
                                                    </div>
                                                        ...
                                                        <div class="form-group row m-4">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    <input type="date" class="form-control"
                                                                        id="date_fabrication" name="date_fabrication"
                                                                        value="<?php echo $date_fabrication; ?>">
                                                                </div>
                                                                <div class="col-xl-4">
                                    ...
                                    <div class="col-sm-3 col-md-3 mt-5">
                                        <div class="text-center">
                                            <!-- Large modal -->
                                            <button type="button" class="btn btn-danger waves-effect waves-light"
                                                data-toggle="modal" data-target=".bs-example-modal">Plus de Détails des
                                                Prix</button>
                                        </div>
                                        <!--  Modal content for the above example -->
                                        <div class="modal fade bs-example-modal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h2 class="modal-title mt-0" id="myLargeModalLabel">Détails des
                                                            prix</h2>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-hidden="true">×</button>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input class="form-control" type="number"
                                                                    placeholder="Prix d'achat HT" value=""
                                                                    name="prix_achat_ht" id="prix_achat_ht">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <b>Prix d'achat TTC </b>
                                                                <input class="form-control" type="number"
                                                                    placeholder="Prix d'achat TTC" value=""
                                                                    name="prix_achat_ttc" id="prix_achat_ttc">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input class="form-control" type="number"
                                                                    placeholder="Prix de vente HT" value=""
                                                                    name="prix_vente_ht" id="prix_vente_ht">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <b>Prix de vente TTC </b>
                                                                <input class="form-control" type="number"
                                                                    placeholder="Prix de vente TTC" value=""
                                    ...
                                    <div class="col-sm-3 col-md-3 mt-5">
                                        <div class="text-center">
                                            <!-- Large modal -->
                                            <button type="button" class="btn btn-danger waves-effect waves-light"
                                                data-toggle="modal" data-target=".bs-example-modal-supp">Plus de Détails
                                                Supplémentaires</button>
                                        </div>
                                        <!--  Modal content for the above example -->
                                        <div class="modal fade bs-example-modal-supp" tabindex="-1" role="dialog"
                                            aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    placeholder="Code NGP" value="" name="code_ngp"
                                                                    id="code_ngp">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <b>Numéro Série </b>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Numéro Série" value=""
