                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" style="background: #ffc107  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==1){ ?> active show <?php } } ?>"
                                        data-toggle="tab" href="#famille" role="tab">Famille</a>
                                </li>
                                <li class="nav-item" style="background: #ffc107  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==2){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#unite" role="tab">Unité </a>
                                </li>
                                <li class="nav-item" style="background: #ffc107  !important;">
                                ...
                                <li class="nav-item" style="background: pink  !important; ">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==5){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#devis" role="tab">Devise</a>
                                </li>
                                <li class="nav-item" style="background: pink  !important;">
                                ...
                                <li class="nav-item" style="background: pink  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==16){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#pays" role="tab">Retenue à la source</a>
                                </li>
                                <li class="nav-item" style="background: #89c4a9 !important;">
                                ...
                                <li class="nav-item" style="background: #cd5dfc  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==14){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#vehicules" role="tab">Véhicule</a>
                                </li>
                                <li class="nav-item" style="background: #cd5dfc  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==15){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#commerciaux" role="tab">Commerciaux</a>
                                </li>

                                <li class="nav-item" style="background: #eddff2  !important;">
                                    <a class="nav-link <?php if(isset($_GET['suc'])){ if($_GET['suc']==13){ ?> active <?php } } ?>"
                                        data-toggle="tab" href="#parametres" role="tab">Paramètres</a>
                                </li>
                            </ul>
