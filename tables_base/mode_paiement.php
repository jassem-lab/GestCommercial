...
<form action="" method="POST">
     <div class="form-group row" id="DivMOD" <?php if(!isset($_GET['add7']) and !isset($_GET['IDMP']) ){?> style="display:none" <?php }?>>
...
<div class="col-xl-12">
   	<div class="col-xl-12 row">
		...
		<div class="col-xl-3">
			<button type="button" class="btn btn-primary waves-effect waves-light" id="btnAjoutMOD"  <?php if(isset($_GET['add7']) and (isset($_GET['IDMP'])) ){?> style="display:none" <?php }?>>+ Ajouter</button>
			<button type="button" class="btn btn-danger waves-effect waves-light" id="btnAnnulerMOD"  <?php if(!isset($_GET['add7']) and !isset($_GET['IDMP'])){?> style="display:none" <?php }?>>- Annuler</button>
		</div>			
	</div>
    ...
    <table class="table mb-0">
        ...
        <tbody>
            <?php 
            $reqFP ="select * from delta_mode_paiement"; 
