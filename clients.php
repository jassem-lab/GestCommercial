            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <a href="addedit_client.php" class="btn btn-primary waves-effect waves-light">Ajouter un Client</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  style="padding: 2px 2px;">
                                        ...
                                        <a href="addedit_client.php?ID=<?php echo $id; ?>" class="btn btn-warning waves-effect waves-light">
