...
<?php
	...
	$nom				=	"";
	$prenom				=	"";	
	$req="select * from delta_utilisateurs where id=".$id." and codsoc=".$_SESSION['delta_SOC'];
...
<div class="wrapper">
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Autorisation des accès pour l'utilisateur : <?php echo $nom.' '.$prenom;?></h4>
                </div>
            </div>
        </div>
        <!-- end container-fluid -->
...
<?php
	if(isset($_POST['enregistrer_mail'])){	
		...
		if(mysql_num_rows($query)<1){
			$sql="INSERT INTO delta_autorisation_utilisateur (idutilisateur,codsoc) values ('".$id."','".$_SESSION['delta_SOC']."')";
			$requete=mysql_query($sql);
		}	

	
		if(isset($_POST["utilisateurs"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `utilisateurs.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `utilisateurs.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}

		if(isset($_POST["socs"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `socs.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `socs.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}
		
		if(isset($_POST["tabs"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `tabs.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `tabs.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}		
		
		if(isset($_POST["produits"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `produits.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `produits.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}			
		
		
		if(isset($_POST["addedit_produit"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_produit.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_produit.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	

		
		if(isset($_POST["clients"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `clients.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `clients.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	

		
		if(isset($_POST["addedit_client"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_client.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_client.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	

		
		if(isset($_POST["fournisseurs"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `fournisseurs.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `fournisseurs.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	

		
		if(isset($_POST["addedit_fournisseur"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_fournisseur.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `addedit_fournisseur.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}			
		
		if(isset($_POST["gest_be"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_be.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_be.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}			
		
		
		if(isset($_POST["gest_bs"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bs.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bs.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}			
		
		if(isset($_POST["gest_devis"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_devis.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_devis.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}			
		
		
		if(isset($_POST["gest_bc"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bc.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bc.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
		
		if(isset($_POST["gest_bl"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bl.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_bl.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["gest_fact"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_fact.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_fact.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["gest_avoir"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_avoir.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_avoir.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["gest_paie_cli"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_paie_cli.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_paie_cli.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["gest_paie_frn"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_paie_frn.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_paie_frn.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["journal"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `journal.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `journal.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["ca"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `ca.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `ca.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["cli_frn"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `cli_frn.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `cli_frn.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["stock_prd"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `stock_prd.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `stock_prd.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
				
		if(isset($_POST["mvt_stock"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `mvt_stock.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `mvt_stock.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}

		if(isset($_POST["val_stock"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `val_stock.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `val_stock.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}
		if(isset($_POST["inventaire_stock"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `inventaire_stock.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `inventaire_stock.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}
		if(isset($_POST["autorisation_profils"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_profils.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_profils.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	
		if(isset($_POST["autorisation_users"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_users.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_users.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}	

		if(isset($_POST["autorisation_addprofils"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_addprofils.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
			$sql="UPDATE delta_autorisation_utilisateur SET `autorisation_addprofils.php`=0 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		}
		if(isset($_POST["gest_det_devis"])){
			$sql="UPDATE delta_autorisation_utilisateur SET `gest_det_devis.php`=1 where idutilisateur=".$id." and codsoc=".$_SESSION['delta_SOC'];
			$requete=mysql_query($sql);
		} else{
